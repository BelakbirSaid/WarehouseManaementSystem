...
namespace MaghrebAccessoiresPickingSolutionUI
{
    public partial class InitForm : Form
    {
        ...
        //public string[] couls = { "1", "2", "3"};
        public string[] coul = {"5"};
        public string[] coul1 = { "1", "2"};


        public DataTable Picking;
        public DataTable SitAP;

        //public string connectionString = "Server=(localdb)\\MyInstance1;Integrated Security=true; Database = copydb;";
        //public string connectionString1 = "Server=(localdb)\\MyInstance1;Integrated Security=true; Database = EmpOptimisation;";
        //public String connectionString = "Data Source=192.168.50.203;Initial Catalog=B2B;User ID=excel1;Password=mmmmmm";
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (progressBar1.Value >= progressBar1.Maximum)
            {
                ...
                this.label1.Text = "Cette etape est reussie ! ";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // loop on Lesvels   
                // loop on aisle
                //Parallel.For(0, coul.Length, A => { });


                for (int A = 0; A < coul.Length; A++)
                {
                    ...
                    using (SqlConnection connection2 = new SqlConnection(connectionString))
                    {
                        ...
                        else
                        {
                            ...
                            /// affectation des emplacement 
                            /// pour le 3levels dtbl6 
                            /// 
                            /// 
                            /// 
                            //dtbl6Copy = dtbl6;
                            ...
                            {
                                string sqQueryEmpl = "select [Emp] ,[MAG] ,[A] ,[C] ,[H] ,[Index] AS indice,[Distance],[Hauteur],[Longueur],[Profondeur],[Classe] from  siteAP where MAG like 'MAG" + levels[0] + "%' and A like 'A0" + coul[A] + "       %' order by [Index]";
                            ...
                            // this.dataGridView2.DataSource = Empldtbl; 
                            ...
                            /// la phase d'enregistrement des datatables 
                            ///
                            //loop into datatable 
                            // dtbl6 
                    ...
                    //this.dataGridView3.DataSource = Empldtbl;
                    Thread.Sleep(1000);
            ...
            try
            {
                ...
                for (int A = 0; A < coul.Length; A++)
                {
                    ...
                    using (SqlConnection connection2 = new SqlConnection(connectionString))
                    {
                        ...
                        string sqQueryC = "SELECT  t1.ItemCode AS reference ,t2.U_emp AS EmpAct , SUM(t3.Quantity)/(Count(t3.DocEntry)+1) AS TPALL , t1.OnHand AS Stock_actuel,Sum(t3.Quantity)*4/12 AS QT3Mois,sum(t3.Quantity) AS Quantity, AVG(t3.PriceBefDi) Prix_Unitaire , count(t3.ItemCode) AS Nombre_de_Factures, t1.U_Largeur AS lar , t1.U_Longueur AS prof , t1.U_Hauteur AS haut , t1.U_F_Art AS Famille,t1.U_CodeMarque AS CM,t1.ItemName AS Dsc from oitm t1 join oitw t2 on t1.ItemCode = t2.ItemCode right join inv1 t3 on t1.ItemCode = t3.ItemCode where t2.WhsCode = '01' and t2.U_emp like 'MAG" + levels[0] + "-A" + coul1[A] + "-%' and  t3.DocDate between '2021' and '2022' group by  t1.ItemCode , t1.OnHand ,t1.U_Largeur , t1.U_Longueur , t1.U_Hauteur , t1.U_F_Art ,t2.U_emp  , t1.U_CodeMarque,t1.ItemName";
                        SqlCommand command3 = new SqlCommand(sqQueryC, connection2);
                        SqlDataAdapter dataAdapter = new SqlDataAdapter(command3);
                        // DataTable dtbl3 = new DataTable();
                        DataTable tableP = new DataTable();
                        ...
                        else
                        {
                            ...
                            using (SqlConnection connection3 = new SqlConnection(connectionString1))
                            {
                                string sqQueryEmpl = "select [Emp] ,[MAG] ,[A] ,[C] ,[H] ,[Index] AS indice,[Distance],[Hauteur],[Longueur],[Profondeur],[Classe] from  siteAP where MAG like 'MAG" + levels[0] + "%' and A like 'A0" + coul1[A] + "       %' order by [Index]";
                                SqlCommand command4 = new SqlCommand(sqQueryEmpl, connection3);
                                SqlDataAdapter dataAdapter4 = new SqlDataAdapter(command4);
                                // DataTable dtbl3 = new DataTable();
                                DataTable tableEMP = new DataTable();
